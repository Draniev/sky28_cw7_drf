    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execution_seconds', models.PositiveIntegerField(default=60)),
                ('periodicity', models.CharField(choices=[('hourly', 'every hour'), ('daily', 'every day'), ('weekly', 'every week')], default='daily', max_length=10)),
